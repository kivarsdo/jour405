...
- I think the distribution is normal because there is one central mean and it is relatively in the middle of the data. While it might skew a little to the left, I think most of the data is within range to be considered as normal.

- I would say that on the left side, one standard deviation from the mean, the range is normal but on the right side the one standard deviation from the mean, the range is a little high.
